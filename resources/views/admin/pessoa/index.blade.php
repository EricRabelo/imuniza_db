            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="detalhes-endereco">Endereco</label>
                            <input id="detalhes-endereco" name="detalhes-endereco" class="form-control" readonly>
                        </div>
                        <div class="form-group col-md-6 col-sm-12">
        ...
        $(document).ready(function() {
            ...
            $('#modal-detalhes').on('show.bs.modal', function(event) {
                ...
                $.getJSON(url, (resposta) => {
                    ...
                    $("#detalhes-endereco").val(resposta.endereco);
