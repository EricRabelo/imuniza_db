        ...
        <div class="col-12">
            <div class="card-box table-responsive">
                <div style="display: flex;justify-content: space-between" class="card-header py-2 mb-3">
                    <h6 class="mt-3 font-weight-bold text-grey">Listagem de Registros</h6>
                    <a href=" {{ route('admin.registrovacinacao.create') }} " class="btn btn-primary my-2">Novo Registro</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a type="button" title="Editar Registro" class="btn btn-warning"
                                        href="{{ route('admin.registrovacinacao.editar', ['id_Pessoa' =>$registro->id_Pessoa, 'id_Vacina' => $registro->id_Vacina, 'dataVacinacao' => $registro->dataVacinacao]) }}"><i
                                            class="dripicons-pencil"></i></a>
                                    <!-- Botao apagar -->
                                    <button type="button" title="Apagar Registro" class="btn btn-danger" data-toggle="modal"
                                        data-target="#modal-excluir" data-id="{{$registro->id_Pessoa}}/{{$registro->id_Vacina}}/{{$registro->dataVacinacao}}"><i
    ...
    <div id="modal-excluir" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" align="center">Tem certeza de que quer excluir esse Registro?</div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#modal-excluir').on('show.bs.modal', function(event) {
                ...
                $('#form-excluir').attr('action', 'registrovacinacao/' + id)
